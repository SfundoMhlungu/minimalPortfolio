...
const projectDetail = {
    Frame: {
        ...
        lessons: [
            "Amongst many the most valuable lesson I learned here is the power of design patterns, and how they foster efficient and iterative development, for example I had a working MVP of frame in about 11 days because of the MVC pattern and it's efficiency for iterative development.",
    ...
    "Gym Suite": {
        ...
        project_implementation: [
            ...
            "The dashboard component feeds from the data gathered by the session component and visualize the data in a meaningful and intepretive way "
        ],
        stack_explanation: {
            stack: [
                {
            ...
            explanations: [
                "I used React.js and Material for iterative development and awasome looking reusable components which came in handy in such a project",
                "To manage complex state I used a the Xstate state machine, which is super efficient and powerful enough to coordinate complex state changes such as the ones happening in the state component.",
                "The most powerful tool I probably used here also is React query which is magical for state management, database query and update asynchornously"
            ]
        },
        visuals: [],
        problems: [
            "The only hurdle I faced here is managing multiple chnaging states manually which actually broke the application as there were many moving pieces, changing constantly because of timers etc, that is when I turned to xstate and React query"
        ],
        featured_code: [
            {
                name: "",
        ...
        lessons: [
            "Inveting the wheel is a bad idea especially if there's a well tested tool out there for the task at hand, this is how I actually discovered React query and instantly fell in love",
            "Before gym suite I didn't like Test Driven Development, after trying it out I can say I am a huge fan and now see testing as a very useful technique and can actually increase development speed a lot as I was able to develop the core of the application in about 4 hours with TDD which normally takes me about 2 days without TDD"
        ],
        lesson_vis: [],
        isWhite: true
    },
    "AlgoViz": {
        ...
        project_implementation: [
            ...
            "The main thread in this is only responsible for updating the UI, whilst workers do all the heavy lifting and calculations and just communicate the results when ready to the main thread for update using comlink developed by under Google to make web workers enjoyable."
        ],
        stack_explanation: {
            stack: [
                {
            ...
            explanations: [
                "As alluded before AlgoViz uses web workers to achieve threaded programming with each algorithm, both sorting and graph algorithms running on their own threads and using comlink to communicate with the main thread",
                "Whilst for the frontend I used a tiny library I created Atomicus to create stateful, self contained HTML element"
            ]
        },
        visuals: [],
        problems: [
            "The main problem I faced was debugging web workers as it was my first time I was using comlink with web workers as I usually implement a pattern from scratch, but with a little research and looking at the codebase a little I was able to figure out a few details"
        ],
        featured_code: [
            {
                name: "",
        ...
        lessons: [
            "As Surma puts on his talk 'The main thread is overworked' sometimes slower does not mean bad for the user but a janky UI does - as he was refering to the passing of data between threads which can be slow a times depending on the size of data while this might be slow which is rare does not cause the browser to freeze as it frees the main thread to handle the UI, so no this page is slowing down your browser, I learned that web workers can probably make it possible to bring computive intensive apps entirely to the client side"
        ],
        lesson_vis: [],
        isWhite: true
    },
    ...
    Petal: {
        ...
        lessons: [
            "immediately after finishing this framework I noticed an increase in my coding and problem solving skills, even frontend, from then till now I learnt the importance of learning and implementing lower level concepts as a self taught developer, since then I learned a few lower level languages like Zig and C"
        ],
        lesson_vis: [],
        isWhite: false
    },
    Atomicus: {
        ...
        stack_explanation: {
            ...
            explanations: [
                "I almost always use Typescript for libraries that I intend to use in the long as I find TS very robust and highly mantainable"
            ]
        },
        visuals: [
            "./projects/6.png",
