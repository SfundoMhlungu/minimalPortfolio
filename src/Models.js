...
export const projectDetail = {
    Frame: {
        ...
        stack_explanation: {
             ...
             explanations: ["bokke.js is at the core of Frame, functionality-wise, as it is responsible for turning CSV into tabular data, visualization, manipulation, and data cleaning, the coolest part probably is bokke.js run's on a separate thread isolating large data and heavy calculations from the main thread, which only handles UI updates, I built bokke.js entirely with Typescript which makes it robust and easily maintainable.", "Ml5 is responsible for everything Machine Learning, from fitting models to downloading them to be used in the browser, as Ml5 is built on top of tensorflow.js.", "Atomicus another frontend tool I built is probably the heavy lifter of this web app in terms of frontend, which is responsible for creating self-contained, self-aware stateful HTML elements, establishing communication between them using the MVC pattern, and facilitating communication also between elements and ML5, elements and bokke.js", "Express is responsible for everything server side, authentication, signup, saving models to a remote database with an account."],
        ...
        lessons: ["Amongst many, the most valuable lesson I learned here is the power of design patterns, and how they foster efficient and iterative development, for example, I had a working MVP of frame in about 11 days because of the MVC pattern and its efficiency for iterative development.", "Frame is compute-intensive and heavy, by using web workers I had an opportunity to learn and experience how to bring compute-intensive applications to the client side."],
        lesson_vis: [],
        isWhite: true
    },
    "Gym Suite": {
    ...
    "AlgoViz": {
        ...
        project_implementation: ["The entire application depends on the communication between threads/web workers and the main thread.", "The main thread is only responsible for updating the UI, whilst workers do all the heavy lifting and, calculations and just communicate the results when ready to the main thread to update the UI using comlink, developed by under Google to make web workers enjoyable."],
        stack_explanation: {
             stack:  [{icon:"./svg/web.svg", name: "workers"}, {name: "Atomicus",icon:"./man-technologist-medium-skin-tone.09a6d491.svg"}],
             explanations: ["AlgoViz uses web workers to achieve threaded programming with each algorithm, both sorting and graph algorithms running on their own threads and using comlink to communicate with the main thread.", "Whilst for the frontend I used a tiny library I created Atomicus to create stateful, self-contained HTML elements."],
            
        },
        visuals: [],
        problems: ["The main problem I faced was debugging web workers as it was the first time I was using comlink with web workers, I usually implement a pattern from scratch, but with a little research and looking at the codebase a little I was able to figure out a few details."],
        featured_code: [
            {
                name: "", 
                code: ""
        ...
        lessons: ["As Surma puts in his talk 'The main thread is overworked' sometimes slower does not mean bad for the user but a janky UI does - as he was referring to the passing of data between threads which can be slow at times depending on the size of data while this might be slow which is rare does not cause the browser to freeze as it frees the main thread to handle the UI, so no this page is slowing down your browser, I learned that web workers can probably make it possible to bring computive intensive apps entirely to the client side."],
        lesson_vis: [],
        isWhite: true
    },
    Pam: {
        ...
        stack_explanation: {
             ...
             explanations: ["I used next.js with tailwind CSS for this app, to create reusable components which actually allowed iterative development and maintaining a solid design system.", "Ionic was primarily used for bundling the web app into an android installable APK, using capacitor js.", "I needed beautiful, efficient, and performant charts since this was running on mobile, and chart.js came in handy for such a task."],
            
        },
        visuals: ["./projects/Pam/2.png",  "./projects/Pam/3.png", "./projects/Pam/4.png"],
        problems: ["A huge problem I ran into was definitely creating charts solely for mobile because you can only have so much control over charts, they are like images very unruly in terms of size, aspect ratio, etc.", "Because of this, I became well-versed in different chart types and their uses and effectiveness in conveying findings and visual messages.", "Another problem I came across was domain knowledge, I did not really know anything about allergies and my friend had no knowledge of programming so I had to find a way to converge the two world's so we were able to communicate and create something together while understanding each other."],
        featured_code: [
            {
                name: "", 
                code: ""
        ...
        lessons: ["One of the most important lessons I came out with here is communicating programming solutions to non-programmers, and vice versa, getting enough useful domain knowledge from a 'client' to be able to create something useful and usable."],
        lesson_vis: [],
        isWhite: false
    },
    Petal: {
        ...
        lessons: ["immediately after finishing this framework, I noticed an increase in my coding and problem-solving skills, even frontend, from then till now I learned the importance of learning and implementing lower-level concepts as a self-taught developer, since then I learned a few lower-level languages like Zig and C."],
        lesson_vis: [],
        isWhite: false
    },
    Atomicus: {
        ...
        stack_explanation: {
             ...
             explanations: ["I almost always use Typescript for libraries that I intend to use in the long as I find TS very robust and highly maintainable."],
