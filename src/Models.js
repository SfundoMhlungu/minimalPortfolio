...
export const projectDetail = {
    Frame: {
        ...
        stack_explanation: {
             stack:  [{icon:"./man-technologist-medium-skin-tone.09a6d491.svg", name: "bokke.js"}, {icon:"./ml5.png", name: "ML5"}, {name: "Atomicus",icon:"./man-technologist-medium-skin-tone.09a6d491svg"}, {icon: "./svg/express-original.svg", name: "Express"}],
