...
export const projects_model = [
    ...
    tools: ["JavaScript"],
    links: [{link: "", type: "github"}, {link: "", type:"yt"}],
...
export const projectDetail = {
    Frame: {
        ...
        visuals: [ "./projects/frame/scatter plot.png",  "./projects/frame/nn training.png",  "./projects/frame/nn.png" ],
    ...
    Pam: {
        ...
        visuals: ["./projects/Pam/stats visual.png",  "./projects/Pam/home visual.png", "./projects/Pam/reaction prediction.png"],
        problems: ["", ""],
        featured_code: [
            {
                name: "", 
